...
echo "$j    'jblks'  " > ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "$je    'jblke'  " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "$iblks    'iblks'  " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "$iblke    'iblke'  " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "'$RNNM'   'run num'  " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "'2zi'     'intID'   " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "702       'num uvrfiles'" >>${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
cat $LISN >>${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in

# copy screen output to pbs file
echo "aprun -n 1 ./extract_uvrho_c004_v1.x  < ./extract_uvr_${RNNM}_${j}_${i}.in > ./output_${RNNM}_${j}_${i}.out"
...
# make all the pbs files
  ...
  echo "#PBS -l walltime=12:00:00"        >> ${PTHHO}pbsX_j${j}_${i}
  ...
  echo "aprun -n 1 ./extract_uvrho_c004_v1.x  < ./extract_uvr_${RNNM}_${j}_${i}.in > ./extract_uvr_${RNNM}_${j}_${i}.out" >> ${PTHHO}pbsX_j${j}_${i}
