#!/bin/csh -x
#PBS -N r245_250_1z_archv.2016
#PBS -j oe
#PBS -o r245_250_1z_archv.2016.log
...
if (! -e archv.${Y}_${IN}_${DA}_${h}_S.a ) then #Didn't make this yet?
echo archv.${Y}_${IN}_${DA}_${h}_S.a
