...
echo "$jblks    'jblks'  " > ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
echo "$jblke    'jblke'  " >> ${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
...
echo "1149       'num uvrfiles'" >>${PTHNM}extract_uvr_${RNNM}_${j}_${i}.in
