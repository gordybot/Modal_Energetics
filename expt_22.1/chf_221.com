...
echo "aprun -n 1 ./charmfit_rho.x  < ./chfrho_${RNNM}_${j}_${i}.in > ./chfit_rho${RNNM}_${j}_${i}.out"

# make all the pbs files
  echo "#! /bin/sh"                       > ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -N chfit_rhoj${j}_${i}"             >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -o chfit_rhoj${j}_${i}.out"         >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -e chfit_rhoj${j}_${i}.err"         >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -M gordon.stephenson@usm.edu" >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -m bea"                      >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -A ONRDC38645449"            >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -S /bin/bash"                >> ${PTHHO}pbsX_j${j}_${i}
  echo "#PBS -l walltime=15:00:00"        >> ${PTHHO}pbsX_j${j}_${i}
  ...
  echo "aprun -n 1 ./charmfit_rho.x  < ./pmode_${RNNM}_${j}_${i}.in > ./chfit_rho${RNNM}_${j}_${i}.out" >> ${PTHHO}pbsX_j${j}_${i}
