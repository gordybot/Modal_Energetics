      ...
      ! Found error on line 235-ish. Typo had 
      ! Typo had a "+" instead of a "*" in the line
      !    0.5 * ( P(k) + P(k+1) ). 3/25/18, GS.
        ...
        do j=1-mbdy,blkj+mbdy
          ...
          if (cc.GT.1) then
           ...
           do l=1,MEIG
            ...
            Uvec(:) = 0.0
            ! Get rid of some Infinity values.
            if (sum1.GT.0.0) then
              do k=1,cc
            ...
            ! Make sign positive at bottom.
            signUvec = 1
            if (Uvec(cc).LT.0.0) then
!            if (A(cc,l).LT.0) then !ERROR A is all 0.
              signUvec = -1
            endif
