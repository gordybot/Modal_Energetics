...
!     &          blk_mHFp(1:iblk,1:jblk,1:MEIG,2)
            ...
            infileK = '/p/work1/grstephe/hycom/GLBc0.04/expt_22.1/'
     &        //'modes/'
     ...
     &          numstr(iblk)//'.BinF'
            ...
            infile_plat='/p/work1/grstephe/hycom/GLBc0.04/expt_22.1/'
     ...
     &            status='OLD', access='sequential',action='READ')
            ...
            ! Load depth.
            infile_depth='/p/work1/grstephe/hycom/GLBc0.04/expt_22.1/'
     ...
     & 'modes_global/glb_phfvm_nov.BinF'
...
!         write(98) glb_mHFp_sin(:,:,l)
     ...
     & 'modes_global/glb_APE_mode'//numstr(l)//'_nov.BinF'
