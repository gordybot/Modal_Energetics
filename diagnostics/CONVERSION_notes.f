      ...
      character*3 runid
      character outfil*240, infile*240
     ...
     &                    1:MEIG, 1:3) )
      ...
      do jblk=jblks,jblke
        do iblk=iblks,iblke
          ...
          infileZ = '/p/work1/mbui/hycom/GLBc0.08/expt_22.1/'
     ...
     &            status='OLD', access='sequential',action='READ')
          ...
          infileDX= '/p/work1/mbui/hycom/GLBc0.08/expt_22.1/'
     ...
     &            status='OLD', access='sequential',action='READ')
          ...
          infileDY= '/p/work1/mbui/hycom/GLBc0.08/expt_22.1/'
     ...
     &             blk_conv(i,j,l)
      ...
      do l=1,MEIG
        outfil= '/p/work1/grstephe/hycom/GLBc0.08/expt_05.1/'//
