      ...
      IMPLICIT NONE
      ! Re-ran and modified charmfit_ubaro221 / vbaro221
       ! Dropped singleton dimension (i,j, 1, 1:3)
       ! So it's just (i,j,1:3) now.
...
!pbot_hfvm_221_blk_10_10_apr.BinF
...
!     &      + 0.5*(dhdy_S + dhdy_N)* v_conj_C*p_botn_C )
     ...
     &        '_mode'//numstr(l)//'_apr_test2.BinF'
