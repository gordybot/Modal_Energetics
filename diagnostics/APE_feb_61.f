       ...
       !!! I have been loading pbot instead of p --- ?!
       !!!      Found 3/12/18, GS.
       ...
       real, allocatable, dimension(:,:,:,:) :: glb_p
     ...
     & 1:2,1:MEIG) )
       ...
       allocate( glb_p(1:idm,1:jdm,1:2,1:MEIG) )
...
!     &     'modes/P_vmhf_'//runid//'_blk_'//numstr(jblk)//
     &     'modes/phfvm_'//runid//'_blk_'//numstr(jblk)//
     &     '_'//numstr(iblk)//'_mar.BinF'
