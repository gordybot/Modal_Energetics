       ...
       real, allocatable, dimension(:,:,:,:) :: fluxUV
     ...
     &            status='OLD', access='sequential',action='READ')
       ...
       ! modeU * modeP * depth.
        ...
        cblk_fluxU(i,j,l) = real(
     &       0.5* cmplx(blk_modeU(i,j,l,2), -1*blk_modeU(i,j,l,3))
     &       * cmplx( blk_modeP(i,j,l,2), blk_modeP(i,j,l,3) ) * z )
        cblk_fluxV(i,j,l) = real(
     &       0.5* cmplx(blk_modeV(i,j,l,2), -1*blk_modeV(i,j,l,3))
     &       * cmplx( blk_modeP(i,j,l,2), blk_modeP(i,j,l,3) ) * z )
             endif
