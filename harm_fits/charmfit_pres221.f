       ...
       allocate( THING(1-mbdy:blki+mbdy, 1-mbdy:blkj+mbdy, 
     &            1:maxobstot, 1:MEIG))
     ...
     &            1:MEIG,1:3) )
       ...
       allocate( Bhf( 1:maxobstot,1:MEIG) )
     ...
     &            '81','82','83','84','85','86','87','88','89','90'/
       ...
       do iblk=iblks,iblke
         ...
         ! Load THING.
!         infile_THING='/p/work1/grstephe/hycom/GLBc0.08/expt_05.1/'
!     &   //THINGstr//'/'
!     &   //THINGstr//'_'//runid//'_blk_'//numstr(jblk)//'_'//
!     &   numstr(iblk)
!     &   //'.BinF'
         infile_THING = '/p/work1/grstephe/hycom/GLBc0.04/expt_22.1/'
     &      //'modes/modeP_1z_221_blk_'//numstr(jblk)//'_'//
     &        numstr(iblk)//'_v3.BinF'
         write(6,*) 'Reading THING from ',infile_THING
         call flush(6)
       inquire( file=infile_THING, EXIST=isThere)
       if (isThere) then
     ...
     &     form='unformatted',action='read')
         ...
         ! TODO: Change depending on format of input file.
       ...
       do j=1-mbdy,blkj+mbdy
         ...
         Bhf = THING(i,j,1:maxobstot, 1:MEIG)
!        call SGELS('N',kdm,MEIG+1,maxobstot,A,kdm,BV,kdm,
     ...
     &            maxobstot,WORK(1:LWORK), LWORK, INFO)
         ...
         if(INFO.EQ.0) then
           do l=1,MEIG
             ...
             HF_out(i,j,l,1)=meanHF
             HF_out(i,j,l,2)=Bhf(2,l) !ampHF
             HF_out(i,j,l,3)=Bhf(3,l) !phaseHF
     ...
     &       form='unformatted',access='sequential')
       ...
       close(88)
         ...
         write(6,*) infile_THING, 'does not exist (yet).'
       endif ! isThere...
