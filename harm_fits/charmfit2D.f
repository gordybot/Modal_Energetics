       ...
       parameter(IL=1,IU=5)
       parameter(maxobstot=679) ! 167 for expt_05.1
       ...
       allocate( THING(1-mbdy:blki+mbdy, 1-mbdy:blkj+mbdy, 1:maxobstot))
...
!     &   numstr(iblk)
!     &   //'.BinF'
         infile_THING = '/p/work1/mbui/hycom/GLBc0.08/expt_06.1/'
     &      //'ubaro/ubaro_061_blk_'//numstr(jblk)//'_'//
     &        numstr(iblk)//'.BinF'
     ...
     &            maxobstot,WORK(1:LWORK), LWORK, INFO)
         ...
         if(INFO.EQ.0) then
           do l=1,MEIG
             ...
             HF_out(i,j,l,2)=Bhf(2) !ampHF
             HF_out(i,j,l,3)=Bhf(3) !phaseHF
       ...
       outfileHF='/p/work1/grstephe/hycom/GLBc0.08/expt_05.1/'
     & //'HarmonicFit/'
